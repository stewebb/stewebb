...
<div class="<?php echo esc_attr($portfolio_expert_blog_container); ?> mt-5 mb-5 pt-5 pb-5">
				...
				<?php if (have_posts()) : ?>
					...
					<header class="page-header search-header shadow-sm p-4 mb-5 text-center">
						<h1 class="page-title">
							...
							printf(esc_html__('Search Results for: %s', 'portfolio-expert'), '<span>' . get_search_query() . '</span>');
							?>
						</h1>
					</header><!-- .page-header -->
